...
const mt = oe("string"),
  ...
  Tt = F("URLSearchParams"),
  [At, Ct, xt, _t] = ["ReadableStream", "Request", "Response", "Headers"].map(
    F
  ),
  Nt = (e) =>
...
const k =
  ...
  Xe = (e) => !H(e) && e !== k;
function pe() {
  const { caseless: e, skipUndefined: t } = (Xe(this) && this) || {},
    n = {},
    r = (s, o) => {
...
const Kt = (e) => {
  ...
  vt = F("AsyncFunction"),
  Xt = (e) => e && (V(e) || A(e)) && A(e.then) && A(e.catch),
  Qe = ((e, t) =>
    e
      ? setImmediate
      : t
...
function tt(e, t, n) {
  ...
  if (
    (o
      ? (i = o(t, s))
      : (i = a.isURLSearchParams(t) ? t.toString() : new we(t, s).toString(r)),
    i)
  ) {
    const c = e.indexOf("#");
    c !== -1 && (e = e.slice(0, c)),
...
const Ee = {
  ...
  nn = typeof URLSearchParams < "u" ? URLSearchParams : we,
  ...
  ln = (Re && window.location.href) || "http://localhost",
  un = Object.freeze(
...
let C = class {
  ...
  set(t, n, r) {
    ...
    else if (a.isString(t) && (t = t.trim()) && !wn(t)) i(yn(t), n);
...
const it = (e) => {
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        "onloadend" in p
          ...
          (p.onabort = function () {
            p &&
              (r(new y("Request aborted", y.ECONNABORTED, e, p)), (p = null));
          }),
          (p.onerror = function (O) {
            const P = O && O.message ? O.message : "Network Error",
              L = new y(P, y.ERR_NETWORK, e, p);
          ...
          f && (([b, u] = ne(f, !0)), p.addEventListener("progress", b)),
          d &&
            p.upload &&
            (([h, g] = ne(d)),
  ...
  Un = async function* (e, t) {
    for await (const n of Dn(e)) yield* Fn(n, t);
  },
  Dn = async function* (e) {
  ...
  Bn = (e) => {
    e = a.merge.call({ skipUndefined: !0 }, Ln, e);
    ...
    const c = s && Z(qe),
      ...
      l = i && c && He(() => a.isReadableStream(new r("").body)),
      h = { stream: l && ((u) => u.body) };
    s &&
    ...
    return async (u) => {
      ...
      let G = Pn([x, R && R.toAbortSignal()], O),
        $ = null;
      const B =
        G &&
        G.unsubscribe &&
      ...
      try {
        if (
          ...
          let D = new n(m, { method: "POST", body: w, duplex: "half" }),
            I;
          if (
            (a.isFormData(w) &&
  ...
  at = (e) => {
    ...
    for (; c--; )
      (d = o[c]),
        (f = l.get(d)),
        f === void 0 && l.set(d, (f = c ? new Map() : Bn(t))),
        (l = f);
    return f;
  };
at();
const ge = { http: Zt, xhr: Nn, fetch: { get: at } };
a.forEach(ge, (e, t) => {
  if (e) {
    try {
...
function qn(e, t) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    if (
      ((s = r),
      !jn(r) && ((s = ge[(c = String(r)).toLowerCase()]), s === void 0))
    )
...
const ct = { getAdapter: qn, adapters: ge };
function de(e) {
  if (
...
const te = { assertOptions: In, validators: ae },
  N = te.validators;
let j = class {
  constructor(t) {
    (this.defaults = t || {}),
