const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./theme-color-D3mIM0NA.js",
      "./index-w58kBX-A.js",
      "./three-core-Cz6MriGW.js",
      "./index-JPX0KVAp.css",
      "./theme-color-BhmGFnUo.css",
      "./theme-mode-CzE-SbUC.js",
      "./theme-mode-B7cB3CdV.css",
      "./theme-skin-Cp1oZ-pA.js",
      "./theme-skin-Bvwc8Kbh.css",
    ])
) => i.map((i) => d[i]);
import {
  z as f0,
...
import { T as te } from "./toolbar-BQPkvROV.js";
import { s as p0 } from "./service-CRIbvhpw.js";
...
const ne = f0({
    ...
    setup(u) {
      const e = gu(() =>
          ku(
            () => import("./theme-color-D3mIM0NA.js"),
      ...
      return (n, c) => (
        fu(),
        Z0(H0, null, {
          default: zu(() => [A("div", null, [z(F(e)), z(F(t)), z(F(r))])]),
          _: 1,
        })
      );
    },
  }),
  re = Mu(ne, [["__scopeId", "data-v-b480f289"]]),
  Vu = {};
function ce(u) {
  let e = Vu[u];
  if (e) return e;
...
function W(u, e) {
  typeof e != "string" && (e = W.defaultChars);
  const t = ce(e);
  return u.replace(/(%[a-f0-9]{2})+/gi, function (r) {
    ...
    for (let c = 0, o = r.length; c < o; c += 3) {
      ...
      if ((i & 248) === 240 && c + 9 < o) {
        const a = parseInt(r.slice(c + 4, c + 6), 16),
          s = parseInt(r.slice(c + 7, c + 9), 16),
          l = parseInt(r.slice(c + 10, c + 12), 16);
...
function nu(u, e, t) {
  typeof e != "string" && ((t = e), (e = nu.defaultChars)),
    typeof t > "u" && (t = !0);
  const r = ie(e);
  let n = "";
...
lu.prototype.parse = function (u, e) {
  ...
  if (
    ...
    (e || o || c.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
      ((n = c.substr(0, 2) === "//"),
      n && !(o && Xu[o]) && ((c = c.substr(2)), (this.slashes = !0))),
    !Xu[o] && (n || (o && !Yu[o])))
  ) {
    let s = -1;
    for (let f = 0; f < Ju.length; f++)
      (r = c.indexOf(Ju[f])), r !== -1 && (s === -1 || r < s) && (s = r);
    let l, d;
    s === -1 ? (d = c.lastIndexOf("@")) : (d = c.lastIndexOf("@", s)),
      d !== -1 && ((l = c.slice(0, d)), (c = c.slice(d + 1)), (this.auth = l)),
      (s = -1);
    for (let f = 0; f < Wu.length; f++)
      (r = c.indexOf(Wu[f])), r !== -1 && (s === -1 || r < s) && (s = r);
    ...
    this.hostname.length > he && (this.hostname = ""),
  ...
  return (
    ...
    c && (this.pathname = c),
    Yu[t] && this.hostname && !this.pathname && (this.pathname = ""),
    this
  );
};
...
const pe = Object.freeze(
    Object.defineProperty(
      { __proto__: null, decode: W, encode: nu, format: Lu, parse: Ru },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  ...
  _e = Object.freeze(
    Object.defineProperty(
      { __proto__: null, Any: x0, Cc: _0, Cf: xe, P: qu, S: m0, Z: g0 },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
...
const ke = new Map([
  ...
  De =
    (Du = String.fromCodePoint) !== null && Du !== void 0
      ? Du
      : function (u) {
          let e = "";
          return (
...
function Ae(u) {
  return (
    (u >= w.UPPER_A && u <= w.UPPER_F) || (u >= w.LOWER_A && u <= w.LOWER_F)
  );
}
function Fe(u) {
  return (
    (u >= w.UPPER_A && u <= w.UPPER_Z) ||
    (u >= w.LOWER_A && u <= w.LOWER_Z) ||
    Tu(u)
  );
}
function ye(u) {
  return u === w.EQUALS || Fe(u);
}
var y;
(function (u) {
...
class we {
  ...
  stateNumericStart(e, t) {
    return t >= e.length
      ? -1
      : (e.charCodeAt(t) | Ee) === w.LOWER_X
      ? ((this.state = y.NumericHex),
        (this.consumed += 1),
        this.stateNumericHex(e, t + 1))
      : ((this.state = y.NumericDecimal), this.stateNumericDecimal(e, t));
  }
  addToNumericResult(e, t, r, n) {
    if (t !== r) {
      const c = r - t;
      (this.result =
        this.result * Math.pow(n, c) + parseInt(e.substr(t, c), n)),
        (this.consumed += c);
    }
  }
  stateNumericHex(e, t) {
  ...
  emitNumericEntity(e, t) {
    ...
    else if (this.decodeMode === $.Strict) return 0;
    return (
      this.emitCodePoint(Ce(this.result), this.consumed),
      this.errors &&
        (e !== w.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
  ...
  stateNamedEntity(e, t) {
    ...
    let n = r[this.treeIndex],
      c = (n & j.VALUE_LENGTH) >> 14;
    for (; t < e.length; t++, this.excess++) {
      const o = e.charCodeAt(t);
      if (
        ((this.treeIndex = ve(r, n, this.treeIndex + Math.max(1, c), o)),
        this.treeIndex < 0)
      )
        return this.result === 0 ||
          (this.decodeMode === $.Attribute && (c === 0 || ye(o)))
          ? 0
          : this.emitNotTerminatedNamedEntity();
      if (
        ((n = r[this.treeIndex]), (c = (n & j.VALUE_LENGTH) >> 14), c !== 0)
      ) {
        if (o === w.SEMI)
  ...
  emitNamedEntityData(e, t, r) {
    ...
    return (
      this.emitCodePoint(t === 1 ? n[e] & ~j.VALUE_LENGTH : n[e + 1], r),
      t === 3 && this.emitCodePoint(n[e + 2], r),
      r
    );
  }
  end() {
    ...
    switch (this.state) {
      case y.NamedEntity:
        return this.result !== 0 &&
          (this.decodeMode !== $.Attribute || this.result === this.treeIndex)
          ? this.emitNotTerminatedNamedEntity()
          : 0;
      case y.NumericDecimal:
...
function k0(u) {
  let e = "";
  const t = new we(u, (r) => (e += De(r)));
  return function (n, c) {
    let o = 0,
      i = 0;
    for (; (i = n.indexOf("&", i)) >= 0; ) {
      (e += n.slice(o, i)), t.startEntity(c);
      const s = t.write(n, i + 1);
      if (s < 0) {
        o = i + t.end();
        break;
      }
...
function ve(u, e, t, r) {
  const n = (e & j.BRANCH_LENGTH) >> 7,
    c = e & j.JUMP_TABLE;
  if (n === 0) return c !== 0 && r === c ? t : -1;
  if (c) {
    const a = r - c;
...
const E0 = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
  ze = /&([a-z#][a-z0-9]{1,31});/gi,
  Me = new RegExp(E0.source + "|" + ze.source, "gi"),
  Le = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function Re(u, e) {
  if (e.charCodeAt(0) === 35 && Le.test(e)) {
    const r =
      e[1].toLowerCase() === "x"
...
function U(u) {
  return Pe.test(u) ? u.replace(Ne, $e) : u;
}
const je = /[.?*+^$[\]\\(){}|-]/g;
function Ue(u) {
  return u.replace(je, "\\$&");
    ...
    Object.defineProperty(
      {
        ...
        isSpace: E,
        isString: Pu,
        isValidEntityCode: Nu,
        isWhiteSpace: K,
        lib: Ze,
        normalizeReference: pu,
        unescapeAll: J,
        unescapeMd: qe,
      },
      Symbol.toStringTag,
...
function Ge(u, e, t) {
  ...
  if (u.charCodeAt(n) === 60) {
    for (n++; n < t; ) {
      if (((r = u.charCodeAt(n)), r === 10 || r === 60)) return c;
      if (r === 62)
        return (c.pos = n + 1), (c.str = J(u.slice(e + 1, n))), (c.ok = !0), c;
      if (r === 92 && n + 1 < t) {
        n += 2;
        continue;
      }
  ...
  for (
    ;
    n < t && ((r = u.charCodeAt(n)), !(r === 32 || r < 32 || r === 127));
  ...
  return (
    e === n ||
      o !== 0 ||
      ((c.str = J(u.slice(e, n))), (c.pos = n), (c.ok = !0)),
    c
  );
}
function We(u, e, t, r) {
  ...
  for (; c < t; ) {
    if (((n = u.charCodeAt(c)), n === o.marker))
      return (o.pos = c + 1), (o.str += J(u.slice(e, c))), (o.ok = !0), o;
    if (n === 40 && o.marker === 41) return o;
    n === 92 && c + 1 < t && c++, c++;
  }
  return (o.can_continue = !0), (o.str += J(u.slice(e, c))), o;
}
const Je = Object.freeze(
  ...
  q = {};
q.code_inline = function (u, e, t, r, n) {
  const c = u[e];
  return "<code" + n.renderAttrs(c) + ">" + U(c.content) + "</code>";
};
q.code_block = function (u, e, t, r, n) {
  const c = u[e];
  return (
    "<pre" +
    n.renderAttrs(c) +
...
q.fence = function (u, e, t, r, n) {
  const c = u[e],
    o = c.info ? J(c.info).trim() : "";
  let i = "",
    a = "";
  if (o) {
    const l = o.split(/(\s+)/g);
  ...
  if (
    (t.highlight
      ? (s = t.highlight(c.content, i, a) || U(c.content))
      : (s = U(c.content)),
    s.indexOf("<pre") === 0)
  )
    return (
...
`
  ...
  if (o) {
    const l = c.attrIndex("class"),
      d = c.attrs ? c.attrs.slice() : [];
    l < 0
      ? d.push(["class", t.langPrefix + i])
      : ((d[l] = d[l].slice()), (d[l][1] += " " + t.langPrefix + i));
    const b = { attrs: d };
...
q.image = function (u, e, t, r, n) {
  const c = u[e];
  return (
    (c.attrs[c.attrIndex("alt")][1] = n.renderInlineAsText(c.children, t, r)),
    n.renderToken(u, e, t)
  );
};
...
Q.prototype.renderAttrs = function (e) {
  ...
  for (n = "", t = 0, r = e.attrs.length; t < r; t++)
    n += " " + U(e.attrs[t][0]) + '="' + U(e.attrs[t][1]) + '"';
  return n;
};
Q.prototype.renderToken = function (e, t, r) {
  const n = e[t];
  let c = "";
  if (n.hidden) return "";
  n.block &&
...
`),
    ...
    n.nesting === 0 && r.xhtmlOut && (c += " /");
  let o = !1;
  if (n.block && ((o = !0), n.nesting === 1 && t + 1 < e.length)) {
    const i = e[t + 1];
    (i.type === "inline" ||
      i.hidden ||
      (i.nesting === -1 && i.tag === n.tag)) &&
      (o = !1);
  }
  return (
    (c += o
...
Q.prototype.render = function (u, e, t) {
  ...
  for (let c = 0, o = u.length; c < o; c++) {
    const i = u[c].type;
    i === "inline"
      ? (r += this.renderInline(u[c].children, e, t))
      : typeof n[i] < "u"
      ? (r += n[i](u, c, e, t, this))
      : (r += this.renderToken(u, c, e, t));
  }
  return r;
};
function S() {
    ...
    e.forEach(function (t) {
      (u.__cache__[t] = []),
        u.__rules__.forEach(function (r) {
          r.enabled &&
            ((t && r.alt.indexOf(t) < 0) || u.__cache__[t].push(r.fn));
        });
    });
};
...
S.prototype.before = function (u, e, t, r) {
...
S.prototype.after = function (u, e, t, r) {
  const n = this.__find__(u),
    c = r || {};
  if (n === -1) throw new Error("Parser rule not found: " + u);
...
S.prototype.push = function (u, e, t) {
  const r = t || {};
  this.__rules__.push({ name: u, enabled: !0, fn: e, alt: r.alt || [] }),
    (this.__cache__ = null);
};
...
M.prototype.attrIndex = function (e) {
...
function ut(u) {
  ...
  for (let t = 0, r = e.length; t < r; t++) {
    const n = e[t];
    n.type === "inline" &&
      u.md.inline.parse(n.content, u.md, u.env, n.children);
  }
}
function et(u) {
  return /^<a[>\s]/i.test(u);
  ...
  if (u.md.options.linkify)
    for (let t = 0, r = e.length; t < r; t++) {
      ...
      for (let o = n.length - 1; o >= 0; o--) {
        ...
        if (
          (i.type === "html_inline" &&
            (et(i.content) && c > 0 && c--, tt(i.content) && c++),
          ...
          for (let h = 0; h < s.length; h++) {
            ...
            if (C > b) {
              ...
              (g.content = a.slice(b, C)), (g.level = d), l.push(g);
            }
            ...
            (m.content = k), (m.level = d), l.push(m);
...
function at(u) {
  ...
  for (let t = u.length - 1; t >= 0; t--) {
    const r = u[t];
    r.type === "text" && !e && (r.content = r.content.replace(ct, ot)),
  ...
  if (u.md.options.typographer)
    for (e = u.tokens.length - 1; e >= 0; e--)
      u.tokens[e].type === "inline" &&
        (rt.test(u.tokens[e].content) && at(u.tokens[e].children),
        F0.test(u.tokens[e].content) && st(u.tokens[e].children));
}
const lt = /['"]/,
  Ku = /['"]/g,
  u0 = "’";
...
function dt(u, e) {
  ...
  for (let n = 0; n < u.length; n++) {
    ...
    if (((r.length = t + 1), c.type !== "text")) continue;
    let i = c.content,
      a = 0,
      s = i.length;
    u: for (; a < s; ) {
      ...
      const h = l[0] === "'";
      let f = 32;
      if (l.index - 1 >= 0) f = i.charCodeAt(l.index - 1);
      else
        for (
          t = n - 1;
      ...
      if (a < s) p = i.charCodeAt(a);
        ...
        for (
          ...
          if (u[t].content) {
            p = u[t].content.charCodeAt(0);
            break;
          }
      const k = eu(f) || uu(String.fromCharCode(f)),
        C = eu(p) || uu(String.fromCharCode(p)),
        x = K(f),
        m = K(p);
      if (
        (m ? (d = !1) : C && (x || k || (d = !1)),
        x ? (b = !1) : k && (m || C || (b = !1)),
        p === 34 && l[0] === '"' && f >= 48 && f <= 57 && (b = d = !1),
        d && b && ((d = k), (b = C)),
        !d && !b)
      ) {
        h && (c.content = au(c.content, l.index, u0));
        continue;
      }
      if (b)
        for (t = r.length - 1; t >= 0; t--) {
          ...
          if (_.single === h && r[t].level === o) {
            _ = r[t];
            let g, D;
            h
              ? ((g = e.md.options.quotes[2]), (D = e.md.options.quotes[3]))
              : ((g = e.md.options.quotes[0]), (D = e.md.options.quotes[1])),
              (c.content = au(c.content, l.index, D)),
              (u[_.token].content = au(u[_.token].content, _.pos, g)),
              (a += D.length - 1),
              _.token === n && (a += g.length - 1),
              (i = c.content),
              (s = i.length),
              (r.length = t);
            continue u;
      ...
      d
        ? r.push({ token: n, pos: l.index, single: h, level: o })
        : b && h && (c.content = au(c.content, l.index, u0));
    }
  }
}
function ht(u) {
...
function Ou() {
  this.ruler = new S();
  for (let u = 0; u < Cu.length; u++) this.ruler.push(Cu[u][0], Cu[u][1]);
}
Ou.prototype.process = function (u) {
  const e = this.ruler.getRules("");
  for (let t = 0, r = e.length; t < r; t++) e[t](u);
};
Ou.prototype.State = A0;
function P(u, e, t, r) {
  (this.src = u),
    (this.md = e),
    (this.env = t),
    ...
    (this.level = 0);
  const n = this.src;
  for (let c = 0, o = 0, i = 0, a = 0, s = n.length, l = !1; o < s; o++) {
...
P.prototype.isEmpty = function (e) {
  return this.bMarks[e] + this.tShift[e] >= this.eMarks[e];
};
P.prototype.skipEmptyLines = function (e) {
  for (
    let t = this.lineMax;
...
P.prototype.skipSpaces = function (e) {
...
P.prototype.skipSpacesBack = function (e, t) {
  if (e <= t) return e;
  for (; e > t; ) if (!E(this.src.charCodeAt(--e))) return e + 1;
  return e;
};
P.prototype.skipChars = function (e, t) {
  for (let r = this.src.length; e < r && this.src.charCodeAt(e) === t; e++);
  return e;
};
P.prototype.skipCharsBack = function (e, t, r) {
  if (e <= r) return e;
  for (; e > r; ) if (t !== this.src.charCodeAt(--e)) return e + 1;
  return e;
};
P.prototype.getLines = function (e, t, r, n) {
  if (e >= t) return "";
  ...
  for (let o = 0, i = e; i < t; i++, o++) {
    ...
    let l = s,
      d;
    for (
      i + 1 < t || n ? (d = this.eMarks[i] + 1) : (d = this.eMarks[i]);
      l < d && a < r;

    ) {
      const b = this.src.charCodeAt(l);
      if (E(b)) b === 9 ? (a += 4 - ((a + this.bsCount[i]) % 4)) : a++;
      else if (l - s < this.tShift[i]) a++;
      else break;
      l++;
    }
    a > r
      ? (c[o] = new Array(a - r + 1).join(" ") + this.src.slice(l, d))
      : (c[o] = this.src.slice(l, d));
  }
  return c.join("");
};
P.prototype.Token = M;
...
function e0(u) {
  ...
  for (; r < t; )
    n === 124 &&
      (c
        ? ((i += u.substring(o, r - 1)), (o = r))
        : (e.push(i + u.substring(o, r)), (i = ""), (o = r + 1))),
      (c = n === 92),
      r++,
      (n = u.charCodeAt(r));
...
function xt(u, e, t, r) {
  ...
  for (let _ = 0; _ < s.length; _++) {
    ...
    g.charCodeAt(g.length - 1) === 58
      ? l.push(g.charCodeAt(0) === 58 ? "center" : "right")
      : g.charCodeAt(0) === 58
      ? l.push("left")
      : l.push("");
  }
  ...
  for (let _ = 0; _ < s.length; _++) {
    ...
    l[_] && (g.attrs = [["style", "text-align:" + l[_]]]);
    const D = u.push("inline", "", 0);
    (D.content = s[_].trim()), (D.children = []), u.push("th_close", "th", -1);
  }
  ...
  for (n = e + 2; n < t && !(u.sCount[n] < u.blkIndent); n++) {
    ...
    g.map = [n, n + 1];
    for (let D = 0; D < d; D++) {
      const v = u.push("td_open", "td", 1);
      l[D] && (v.attrs = [["style", "text-align:" + l[D]]]);
      const I = u.push("inline", "", 0);
      (I.content = s[D] ? s[D].trim() : ""),
        (I.children = []),
  ...
  return (
    x && (u.push("tbody_close", "tbody", -1), (x[1] = n)),
...
function mt(u, e, t, r) {
  ...
  for (
    ...
    d++,
      !(
        d >= t ||
        ((n = i = u.bMarks[d] + u.tShift[d]),
        (c = u.eMarks[d]),
        n < c && u.sCount[d] < u.blkIndent)
      );
...
function gt(u, e, t, r) {
  ...
  for (f = e; f < t; f++) {
    ...
    if (((n = u.bMarks[f] + u.tShift[f]), (c = u.eMarks[f]), n >= c)) break;
    if (u.src.charCodeAt(n++) === 62 && !m) {
      let g = u.sCount[f] + 1,
        D,
        v;
      u.src.charCodeAt(n) === 32
        ...
        ? ((D = !0),
          (u.bsCount[f] + g) % 4 === 3 ? (n++, g++, (v = !1)) : (v = !0))
        : (D = !1);
      let I = g;
      for (i.push(u.bMarks[f]), u.bMarks[f] = n; n < c; ) {
        const N = u.src.charCodeAt(n);
        if (E(N))
          N === 9 ? (I += 4 - ((I + u.bsCount[f] + (v ? 1 : 0)) % 4)) : I++;
        else break;
        n++;
      }
      (h = n >= c),
        a.push(u.bsCount[f]),
        (u.bsCount[f] = u.sCount[f] + 1 + (D ? 1 : 0)),
        s.push(u.sCount[f]),
        (u.sCount[f] = I - g),
        l.push(u.tShift[f]),
        (u.tShift[f] = n - u.bMarks[f]);
      continue;
    }
    if (h) break;
    let _ = !1;
  ...
  k.markup = ">";
  const C = [e, 0];
  (k.map = C), u.md.block.tokenize(u, e, f);
  const x = u.push("blockquote_close", "blockquote", -1);
  (x.markup = ">"), (u.lineMax = o), (u.parentType = b), (C[1] = u.line);
...
function Dt(u, e) {
  ...
  for (let r = e + 2, n = u.tokens.length - 2; r < n; r++)
    u.tokens[r].level === t &&
      u.tokens[r].type === "paragraph_open" &&
      ((u.tokens[r + 2].hidden = !0), (u.tokens[r].hidden = !0), (r += 2));
}
function Ct(u, e, t, r) {
  let n,
    c,
  ...
  if ((h = n0(u, a)) >= 0) {
    if (
      ...
      return !1;
  } else if ((h = t0(u, a)) >= 0) d = !1;
  else return !1;
  if (l && u.skipSpaces(h) >= u.eMarks[a]) return !1;
  if (r) return !0;
  const f = u.src.charCodeAt(h - 1),
    p = u.tokens.length;
  d
  ...
  for (u.parentType = "list"; a < t; ) {
    ...
    let g = _;
    for (; c < n; ) {
      const H = u.src.charCodeAt(c);
      if (H === 9) g += 4 - ((g + u.bsCount[a]) % 4);
      else if (H === 32) g++;
      else break;
      c++;
    }
    const D = c;
    let v;
    D >= n ? (v = 1) : (v = g - _), v > 4 && (v = 1);
    const I = _ + v;
    (i = u.push("list_item_open", "li", 1)),
      (i.markup = String.fromCharCode(f));
    const N = [a, 0];
    (i.map = N), d && (i.info = u.src.slice(o, h - 1));
    const X = u.tight,
      mu = u.tShift[a],
      $0 = u.sCount[a],
      j0 = u.listIndent;
    if (
      ...
      (a = u.line),
      (N[1] = a),
      a >= t || u.sCount[a] < u.blkIndent || u.sCount[a] - u.blkIndent >= 4)
    )
      break;
    let Uu = !1;
    for (let H = 0, U0 = x.length; H < U0; H++)
      if (x[H](u, a, t, !0)) {
        Uu = !0;
        break;
      }
    ...
    if (f !== u.src.charCodeAt(h - 1)) break;
  }
  return (
    d
...
function Et(u, e, t, r) {
  ...
  function i(x) {
    ...
    if (
      ...
      const v = u.md.block.ruler.getRules("reference"),
        I = u.parentType;
      u.parentType = "reference";
      let N = !1;
      for (let X = 0, mu = v.length; X < mu; X++)
        if (v[X](u, x, m, !0)) {
          N = !0;
          break;
        }
      if (((u.parentType = I), N)) return null;
    }
    const g = u.bMarks[x] + u.tShift[x],
      D = u.eMarks[x];
    return u.src.slice(g, D + 1);
  }
  let a = u.src.slice(n, c + 1);
  c = a.length;
  let s = -1;
  for (n = 1; n < c; n++) {
    const x = a.charCodeAt(n);
    if (x === 91) return !1;
    if (x === 93) {
      s = n;
      break;
    ...
    } else if (x === 92 && (n++, n < c && a.charCodeAt(n) === 10)) {
      const m = i(o);
      m !== null && ((a += m), (c = a.length), o++);
    }
  }
  ...
  let p = u.md.helpers.parseLinkTitle(a, n, c);
  for (; p.can_continue; ) {
    const x = i(o);
    if (x === null) break;
    (a += x),
      ...
      (c = a.length),
      o++,
      (p = u.md.helpers.parseLinkTitle(a, n, c, p));
  }
  let k;
  for (
    n < c && f !== n && p.ok
  ...
  const C = pu(a.slice(1, s));
  return C
    ? (r ||
        (typeof u.env.references > "u" && (u.env.references = {}),
        typeof u.env.references[C] > "u" &&
          (u.env.references[C] = { title: k, href: d }),
        (u.line = o)),
      !0)
    : !1;
}
const At = [
  ...
  Ft = "[a-zA-Z_:][a-zA-Z0-9:._-]*",
  yt = "[^\"'=<>`\\x00-\\x20]+",
  wt = "'[^']*'",
  vt = '"[^"]*"',
  St = "(?:" + yt + "|" + wt + "|" + vt + ")",
  Tt = "(?:\\s+" + Ft + "(?:\\s*=\\s*" + St + ")?)",
  y0 = "<[A-Za-z][A-Za-z0-9\\-]*" + Tt + "*\\s*\\/?>",
  w0 = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",
  Bt = "<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->",
  It = "<[?][\\s\\S]*?[?]>",
  zt = "<![A-Za-z][^>]*>",
  Mt = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",
...
function qt(u, e, t, r) {
  ...
  if (
    ...
    !u.md.options.html ||
    u.src.charCodeAt(n) !== 60
  )
    return !1;
  let o = u.src.slice(n, c),
    i = 0;
  for (; i < V.length && !V[i][0].test(o); i++);
...
function Pt(u, e, t, r) {
  ...
  (l.content = u.src.slice(n, c).trim()),
    (l.map = [e, u.line]),
    (l.children = []);
  ...
  for (; i < t && !u.isEmpty(i); i++) {
    ...
    if (u.sCount[i] >= u.blkIndent) {
      ...
      if (
        ...
        (o === 45 || o === 61) &&
          ((h = u.skipChars(h, o)), (h = u.skipSpaces(h)), h >= f))
      ) {
        c = o === 61 ? 1 : 2;
        break;
      }
...
const su = [
  ...
  ["reference", Et],
  ["html_block", qt, ["paragraph", "reference", "blockquote"]],
  ["heading", Pt, ["paragraph", "reference", "blockquote"]],
  ["lheading", Nt],
  ["paragraph", Ot],
];
function xu() {
...
xu.prototype.tokenize = function (u, e, t) {
  ...
  for (
    ...
    (u.tight = !i),
      ...
      (o = u.line),
      o < t && u.isEmpty(o) && ((i = !0), o++, (u.line = o));
  }
};
xu.prototype.parse = function (u, e, t, r) {
  if (!u) return;
  const n = new this.State(u, e, t, r);
  this.tokenize(n, n.line, n.lineMax);
};
xu.prototype.State = P;
function ru(u, e, t, r) {
  (this.src = u),
    (this.env = t),
    (this.md = e),
...
ru.prototype.scanDelims = function (u, e) {
  const t = this.posMax,
    r = this.src.charCodeAt(u),
    n = u > 0 ? this.src.charCodeAt(u - 1) : 32;
  let c = u;
  for (; c < t && this.src.charCodeAt(c) === r; ) c++;
  const o = c - u,
    i = c < t ? this.src.charCodeAt(c) : 32,
    a = eu(n) || uu(String.fromCharCode(n)),
...
function Zt(u, e) {
  ...
  if (
    ...
    return !1;
  const n = u.pending.match(Ut);
  if (!n) return !1;
  const c = n[1],
    o = u.md.linkify.matchAtStart(u.src.slice(t - c.length));
  if (!o) return !1;
  let i = o.url;
  if (i.length <= c.length) return !1;
  let a = i.length;
  for (; a > 0 && i.charCodeAt(a - 1) === 42; ) a--;
...
function Ht(u, e) {
  ...
  for (t++; t < n && E(u.src.charCodeAt(t)); ) t++;
  return (u.pos = t), !0;
}
const $u = [];
for (let u = 0; u < 256; u++) $u.push(0);
...
function Vt(u, e) {
  ...
  if (!e) {
    ...
    n < 256 && $u[n] !== 0 ? (i.content = c) : (i.content = o),
      (i.markup = o),
      (i.info = "escape");
  }
  return (u.pos = t + 1), !0;
...
function Gt(u, e) {
  ...
  t++;
  const c = u.posMax;
  for (; t < c && u.src.charCodeAt(t) === 96; ) t++;
  const o = u.src.slice(n, t),
    i = o.length;
...
function r0(u, e) {
  ...
  for (; r.length; ) {
    ...
    o--,
      c !== o &&
        ((t = u.tokens[o]), (u.tokens[o] = u.tokens[c]), (u.tokens[c] = t));
  }
}
function Jt(u) {
  ...
  r0(u, u.delimiters);
  for (let r = 0; r < t; r++) e[r] && e[r].delimiters && r0(u, e[r].delimiters);
}
const v0 = { tokenize: Wt, postProcess: Jt };
function Qt(u, e) {
  const t = u.pos,
    r = u.src.charCodeAt(t);
...
function c0(u, e) {
  ...
  for (let r = t - 1; r >= 0; r--) {
    ...
    (s.type = o ? "strong_close" : "em_close"),
      ...
      (s.content = ""),
      o &&
        ((u.tokens[e[r - 1].token].content = ""),
        (u.tokens[e[n.end + 1].token].content = ""),
        r--);
  }
}
function Xt(u) {
  const e = u.tokens_meta,
    t = u.tokens_meta.length;
  c0(u, u.delimiters);
  for (let r = 0; r < t; r++) e[r] && e[r].delimiters && c0(u, e[r].delimiters);
}
const S0 = { tokenize: Qt, postProcess: Xt };
function Yt(u, e) {
  let t,
    r,
    n,
  ...
  if (f < d && u.src.charCodeAt(f) === 40) {
    for (
      s = !1, f++;
      f < d && ((t = u.src.charCodeAt(f)), !(!E(t) && t !== 10));
      f++
    );
    if (f >= d) return !1;
    if (
      ((a = f),
      (n = u.md.helpers.parseLinkDestination(u.src, f, u.posMax)),
      n.ok)
    ) {
      for (
        o = u.md.normalizeLink(n.str),
          u.md.validateLink(o) ? (f = n.pos) : (o = ""),
          a = f;
        f < d && ((t = u.src.charCodeAt(f)), !(!E(t) && t !== 10));
        f++
      );
      if (
        ((n = u.md.helpers.parseLinkTitle(u.src, f, u.posMax)),
        f < d && a !== f && n.ok)
      )
        for (
          i = n.str, f = n.pos;
  ...
  if (s) {
    ...
    if (
      (f < d && u.src.charCodeAt(f) === 91
        ? ((a = f + 1),
          (f = u.md.helpers.parseLinkLabel(u, f)),
          f >= 0 ? (r = u.src.slice(a, f++)) : (f = h + 1))
        : (f = h + 1),
      r || (r = u.src.slice(b, h)),
      (c = u.env.references[pu(r)]),
      !c)
    )
      return (u.pos = l), !1;
    (o = c.href), (i = c.title);
...
function Kt(u, e) {
  ...
  if (u.src.charCodeAt(u.pos) !== 33 || u.src.charCodeAt(u.pos + 1) !== 91)
    return !1;
  const h = u.pos + 2,
    f = u.md.helpers.parseLinkLabel(u, u.pos + 1, !1);
  if (f < 0) return !1;
  if (((c = f + 1), c < b && u.src.charCodeAt(c) === 40)) {
    ...
    for (
      s = c,
        ...
        i.ok &&
          ((l = u.md.normalizeLink(i.str)),
          u.md.validateLink(l) ? (c = i.pos) : (l = "")),
        s = c;
      c < b && ((t = u.src.charCodeAt(c)), !(!E(t) && t !== 10));
      c++
    );
    if (
    ...
    if (
      (c < b && u.src.charCodeAt(c) === 91
        ? ((s = c + 1),
          ...
          c >= 0 ? (n = u.src.slice(s, c++)) : (c = f + 1))
        : (c = f + 1),
      n || (n = u.src.slice(h, f)),
      (o = u.env.references[pu(n)]),
      !o)
    )
      return (u.pos = d), !1;
    (l = o.href), (a = o.title);
  ...
  if (!e) {
    r = u.src.slice(h, f);
    const p = [];
    u.md.inline.parse(r, u.md, u.env, p);
    const k = u.push("image", "img", 0),
      C = [
        ["src", l],
        ["alt", ""],
      ];
    (k.attrs = C), (k.children = p), (k.content = r), a && C.push(["title", a]);
  }
  return (u.pos = c), (u.posMax = b), !0;
}
const un =
    /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
  en = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function tn(u, e) {
  let t = u.pos;
...
function on(u, e) {
  ...
  const t = u.posMax,
    r = u.pos;
  if (u.src.charCodeAt(r) !== 60 || r + 2 >= t) return !1;
  const n = u.src.charCodeAt(r + 1);
  if (n !== 33 && n !== 63 && n !== 47 && !cn(n)) return !1;
  const c = u.src.slice(r).match(Lt);
  if (!c) return !1;
  if (!e) {
    const o = u.push("html_inline", "", 0);
    (o.content = c[0]),
      nn(o.content) && u.linkLevel++,
      rn(o.content) && u.linkLevel--;
  }
  return (u.pos += c[0].length), !0;
}
const an = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
  sn = /^&([a-z][a-z0-9]{1,31});/i;
function fn(u, e) {
  const t = u.pos,
    r = u.posMax;
  if (u.src.charCodeAt(t) !== 38 || t + 1 >= r) return !1;
  if (u.src.charCodeAt(t + 1) === 35) {
    const c = u.src.slice(t).match(an);
    if (c) {
      if (!e) {
        const o =
            c[1][0].toLowerCase() === "x"
    ...
    const c = u.src.slice(t).match(sn);
    if (c) {
      const o = D0(c[0]);
      if (o !== c[0]) {
        if (!e) {
...
function i0(u) {
  ...
  for (let o = 0; o < t; o++) {
    ...
    if (
      (c.push(0),
      (u[r].marker !== i.marker || n !== i.token - 1) && (r = o),
      (n = i.token),
      (i.length = i.length || 0),
      !i.close)
    )
...
function ln(u) {
  const e = u.tokens_meta,
    t = u.tokens_meta.length;
  i0(u.delimiters);
  for (let r = 0; r < t; r++) e[r] && e[r].delimiters && i0(e[r].delimiters);
}
function dn(u) {
  let e,
    t,
...
function cu() {
  this.ruler = new S();
  for (let u = 0; u < Au.length; u++) this.ruler.push(Au[u][0], Au[u][1]);
  this.ruler2 = new S();
  for (let u = 0; u < Fu.length; u++) this.ruler2.push(Fu[u][0], Fu[u][1]);
}
...
cu.prototype.parse = function (u, e, t, r) {
  const n = new this.State(u, e, t, r);
  this.tokenize(n);
...
function bn(u) {
  return _u(u) === "[object String]";
}
function pn(u) {
  return _u(u) === "[object Object]";
}
function xn(u) {
  return _u(u) === "[object RegExp]";
}
function o0(u) {
  return _u(u) === "[object Function]";
}
function _n(u) {
  return u.replace(/[.?*+^$[\]\\(){}|-]/g, "\\$&");
}
const T0 = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 };
function mn(u) {
...
function hu(u) {
  const e = (u.re = hn(u.__opts__)),
    t = u.__tlds__.slice();
  u.onCompile(),
    u.__tlds_replaced__ || t.push(kn),
    t.push(e.src_xn),
    (e.src_tlds = t.join("|"));
  function r(i) {
  ...
  Object.keys(u.__schemas__).forEach(function (i) {
    ...
    if (((u.__compiled__[i] = s), pn(a))) {
      xn(a.validate)
        ? (s.validate = En(a.validate))
        : o0(a.validate)
    ...
    (u.__compiled__[""] = { validate: null, normalize: a0() });
...
function T(u, e) {
  if (!(this instanceof T)) return new T(u, e);
  e || (mn(u) && ((e = u), (u = {}))),
    (this.__opts__ = Bu({}, T0, e)),
    (this.__index__ = -1),
    (this.__last_index__ = -1),
    (this.__schema__ = ""),
    (this.__text_cache__ = ""),
    (this.__schemas__ = Bu({}, gn, u)),
    (this.__compiled__ = {}),
    (this.__tlds__ = Dn),
...
T.prototype.add = function (e, t) {
  return (this.__schemas__[e] = t), hu(this), this;
};
T.prototype.set = function (e) {
  return (this.__opts__ = Bu(this.__opts__, e)), this;
};
T.prototype.test = function (e) {
  if (((this.__text_cache__ = e), (this.__index__ = -1), !e.length)) return !1;
  let t, r, n, c, o, i, a, s, l;
...
T.prototype.testSchemaAt = function (e, t, r) {
...
T.prototype.match = function (e) {
  ...
  this.__index__ >= 0 &&
    ...
    (t.push(Iu(this, r)), (r = this.__last_index__));
  let n = r ? e.slice(r) : e;
  for (; this.test(n); )
    t.push(Iu(this, r)),
...
function M0(u, e) {
  const t = u.split("@");
  let r = "";
  t.length > 1 && ((r = t[0] + "@"), (u = t[1])), (u = u.replace(Sn, "."));
  const n = u.split("."),
    c = Bn(n, e).join(".");
  return r + c;
}
function L0(u) {
  ...
  for (; t < r; ) {
    ...
    if (n >= 55296 && n <= 56319 && t < r) {
      ...
      (c & 64512) == 56320
        ? e.push(((n & 1023) << 10) + (c & 1023) + 65536)
        : (e.push(n), t--);
    } else e.push(n);
  }
  return e;
}
const In = (u) => String.fromCodePoint(...u),
  zn = function (u) {
    return u >= 48 && u < 58
      ? 26 + (u - 48)
      : u >= 65 && u < 91
  ...
  R0 = function (u, e, t) {
    let r = 0;
    for (u = t ? R(u / yn) : u >> 1, u += R(u / e); u > (yu * tu) >> 1; r += L)
      u = R(u / yu);
    return R(r + ((yu + 1) * u) / (u + Fn));
  },
  q0 = function (u) {
    const e = [],
      t = u.length;
    ...
    for (let i = o > 0 ? o + 1 : 0; i < t; ) {
      ...
      for (let l = 1, d = L; ; d += L) {
        i >= t && O("invalid-input");
        const b = zn(u.charCodeAt(i++));
        b >= L && O("invalid-input"),
          b > R((G - r) / l) && O("overflow"),
          (r += b * l);
        const h = d <= c ? ju : d >= c + tu ? tu : d - c;
        if (b < h) break;
        const f = L - h;
        l > R(G / f) && O("overflow"), (l *= f);
      }
      const s = e.length + 1;
      (c = R0(r - a, s, a == 0)),
        R(r / s) > G - n && O("overflow"),
        (n += R(r / s)),
        (r %= s),
        e.splice(r++, 0, n);
    }
  ...
  P0 = function (u) {
    ...
    let r = I0,
      n = 0,
      c = B0;
    for (const a of u) a < 128 && e.push(wu(a));
    const o = e.length;
    let i = o;
    for (o && e.push(z0); i < t; ) {
      let a = G;
      for (const l of u) l >= r && l < a && (a = l);
      const s = i + 1;
      a - r > R((G - n) / s) && O("overflow"), (n += (a - r) * s), (r = a);
      for (const l of u)
        if ((l < r && ++n > G && O("overflow"), l === r)) {
          let d = n;
          for (let b = L; ; b += L) {
            const h = b <= c ? ju : b >= c + tu ? tu : b - c;
            if (d < h) break;
            const f = d - h,
              p = L - h;
            e.push(wu(s0(h + (f % p), 0))), (d = R(f / p));
          }
          e.push(wu(s0(d, 0))), (c = R0(n, s, i === o)), (n = 0), ++i;
        }
      ++n, ++r;
    }
    return e.join("");
  ...
  Mn = function (u) {
    return M0(u, function (e) {
      return wn.test(e) ? q0(e.slice(4).toLowerCase()) : e;
    });
  },
  Ln = function (u) {
    return M0(u, function (e) {
      return vn.test(e) ? "xn--" + P0(e) : e;
    });
  },
  N0 = {
    version: "2.3.1",
    ucs2: { decode: L0, encode: In },
    decode: q0,
    encode: P0,
    toASCII: Ln,
    toUnicode: Mn,
  ...
  Nn = { default: Rn, zero: qn, commonmark: Pn },
  On = /^(vbscript|javascript|file|data):/,
  $n = /^data:image\/(gif|png|jpeg|webp);/;
function jn(u) {
  const e = u.trim().toLowerCase();
  return On.test(e) ? $n.test(e) : !0;
}
const O0 = ["http:", "https:", "mailto:"];
function Un(u) {
  const e = Ru(u, !0);
  if (e.hostname && (!e.protocol || O0.indexOf(e.protocol) >= 0))
    try {
...
function Zn(u) {
  ...
  return W(Lu(e), W.defaultChars + "%");
}
function B(u, e) {
  if (!(this instanceof B)) return new B(u, e);
  e || Pu(u) || ((e = u || {}), (u = "default")),
    (this.inline = new cu()),
    (this.block = new xu()),
    (this.core = new Ou()),
    (this.renderer = new Q()),
    (this.linkify = new T()),
    (this.validateLink = jn),
    (this.normalizeLink = Un),
    (this.normalizeLinkText = Zn),
    (this.utils = He),
    (this.helpers = bu({}, Je)),
    (this.options = {}),
    this.configure(u),
  ...
  return (
    ...
    u.components &&
      Object.keys(u.components).forEach(function (t) {
        u.components[t].rules && e[t].ruler.enableOnly(u.components[t].rules),
...
const Hn = { class: "log-container w-full flex h-full" },
  Vn = { class: "log-list flex" },
  Gn = { class: "log-header item-center" },
  Wn = ["title"],
  Jn = { class: "log-list-body" },
  Qn = { class: "radio-item" },
  Xn = { class: "label" },
  Yn = { class: "time" },
  Kn = { class: "item-center btn-group" },
  ur = { class: "log-info flex" },
  er = { class: "version-title" },
  tr = ["innerHTML"],
  nr = f0({
    __name: "log",
    props: {
      logInfo: { default: { id: 0, version: "", content: "" } },
      logInfoModifiers: {},
      logList: { default: [] },
      logListModifiers: {},
      totalPage: { default: 0 },
    ...
    emits: V0(
      ["update:changeLogId"],
      ["update:logInfo", "update:logList", "update:totalPage", "update:pageNum"]
    ),
    setup(u, { emit: e }) {
      const { t } = l0.useI18n(),
        r = iu(u, "logInfo"),
        n = iu(u, "logList"),
        c = b0(() => s.render(r.value.content)),
        o = iu(u, "totalPage"),
        i = iu(u, "pageNum"),
        a = e,
        s = new B({ html: !0, linkify: !0, typographer: !0 });
      function l(d) {
        a("update:changeLogId", d);
      }
      return (d, b) => (
        fu(),
        vu("div", Hn, [
          A("div", Vn, [
            A("div", Gn, [
              ...
              A(
                "div",
                { class: "common-text", title: F(t)("setting.text3") },
                Z(F(t)("setting.text3")),
                9,
                Wn
              ),
            ...
            A("div", Jn, [
              z(
                ...
                {
                  logRadio: zu(({ params: h }) => [
                    A("div", Qn, [
                      A("div", Xn, Z(h == null ? void 0 : h.label), 1),
                      A("div", Yn, Z(h == null ? void 0 : h.time), 1),
                    ]),
                  ]),
                  _: 1,
                },
            ...
            A("div", Kn, [
              A(
                "div",
                {
                  class: Su([
                    "w-full common-btn",
                    { "aula-disabled": i.value <= 1 || o.value <= 1 },
                  ]),
                },
                Z(F(t)("master.btn1")),
                3
          ...
          A("div", ur, [
            A("div", er, Z(r.value.version), 1),
            A(
              "div",
              { class: "markdown-body", innerHTML: c.value },
              null,
              8,
              tr
            ),
  ...
  rr = Mu(nr, [["__scopeId", "data-v-d713a6f1"]]);
function cr(u) {
  return p0({ url: "/user/Log/LogList", method: "get", params: u });
}
function ir(u) {
  return p0({ url: `/user/Log/getLogById/${u}`, method: "get" });
}
const or = { class: "flex setting-content" },
  ar = { class: "setting-side-bar" },
  sr = { class: "setting-item-content" },
  fr = { key: 0, class: "w-full h-full" },
  lr = { class: "w-full h-full" },
  dr = {
    __name: "index",
    setup(u) {
      const { t: e } = l0.useI18n(),
        t = ou(0),
        r = b0(() => [
          { value: 0, label: e("setting.text2") },
          { value: 1, label: e("setting.text3") },
          { value: 2, label: e("setting.text4") },
        ]),
        n = ou([]),
        c = ou(1),
        o = ou(1),
        i = ue({ id: "", version: "", content: "" });
      function a() {
        K0.go(-1);
      }
      function s() {
        (n.value.length = 0),
          (o.value = 0),
          (i.content = ""),
          cr({ pageNum: c.value, pageSize: 10 })
            .then((h) => {
              var f, p, k;
              (f = h == null ? void 0 : h.list) != null &&
                f.length &&
                (h.list.forEach((C) => {
                  var x;
                  n.value.push({
                ...
                (i.id =
                  (p = h == null ? void 0 : h.list[0]) == null ? void 0 : p.id),
                l(),
                (i.version =
                  (k = h == null ? void 0 : h.list[0]) == null
                    ? void 0
                    : k.version),
                (c.value = h == null ? void 0 : h.pageNum),
                (o.value = Math.ceil(h.total / 10)));
            })
            .catch((h) => {});
      }
      function l() {
        (i.content = ""),
          ir(i.id)
            .then((h) => {
              (i.version = h.version), (i.content = h.zh);
            })
            .catch((h) => {});
      }
      function d(h) {
      ...
      function b(h) {
        h === 2 && (ee("https://v.wjx.cn/vm/YS7anzp.aspx#"), (t.value = 0));
      }
      return (
        G0(() => {
          s();
        ...
        (h, f) => (
          ...
          vu(
            ...
            {
              class: Su([
                "setting-container flex w-full",
                { "electron-height": F(Y0)() },
              ]),
            },
            [
              z(te),
              A("div", or, [
                A("div", null, [
                  A(
                    "div",
                    { class: "back-btn all-center w-full", onClick: a },
                    [
                      z(d0, { name: "settingBack" }),
                      W0(" " + Z(F(e)("setting.text1")), 1),
                    ]
                  ),
                  A("div", ar, [
                    z(
  ...
  mr = Mu(dr, [["__scopeId", "data-v-a554929a"]]);
